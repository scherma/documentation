...
Currently we know of two problems with NXLog:
  ...
  - On Windows machines NXlog is not able to store its collector state so features like file tailing doesn't work correctly in combination with Sidecar. Use Sidecar version 0.1.0-alpha.1 or newer.
